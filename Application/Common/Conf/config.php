...
return array_merge( $db = array(
	...
	// 数据库配置：
        ...
        //备份数据库配置
        'DB_COPY_PREFIX'        =>  'haoxun_',
        'DB_COPY_NAME'          =>  'haoxun_express_copy',
        'DB_COPY_CONFIG'        =>  'mysql://homyit:homyit_dev@127.0.0.1/haoxun_express_copy#utf8'
	...
	// SESSION 配置
		...
		// 会话保持在线时长（秒）：
		'SESSION_ONLINE'		=>	1000*60,
		'SESSION_OPTIONS'		=>  array('expire'=>60*60*24, 'name'=>'HyFrame_SSID', 'path'=>RUNTIME_PATH.'Temp/'),
		// SESSION配置，一般无需修改
