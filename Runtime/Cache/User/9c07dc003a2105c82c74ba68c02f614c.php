...
var _ROOT_ = '/framework/gitTest/Logistical-PHP',
    ...
    _ACTION_ = '/framework/gitTest/Logistical-PHP/index.php/User/User/all',
    _MODULE_ = '/framework/gitTest/Logistical-PHP/index.php/User',
    _CONTROLLER_ = '/framework/gitTest/Logistical-PHP/index.php/User/User';
</script>
<!-- BEGIN CORE PLUGINS -->
<!--[if lt IE 9]>
