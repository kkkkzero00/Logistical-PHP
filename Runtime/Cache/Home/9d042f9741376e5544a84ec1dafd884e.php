...
<link rel="stylesheet" href="/framework/gitTest/Logistical-PHP/Public/assets/global/styles/frameset/iconfont.css" type="text/css">
    ...
    <link href="/framework/gitTest/Logistical-PHP/Public/assets/global/styles/userinfo/userinfo.css" rel="stylesheet" type="text/css">
				...
				<div class="leftbox col-md-3 col-sm-12">
					<center>
						<div class="leftboxcon">
							<div class="user">
								<div class="userimg">
									<img src="/framework/gitTest/Logistical-PHP/Public/UploadFile<?php echo ($user['savepath']); ?>"  alt="">
								</div>
								<div class="username">
