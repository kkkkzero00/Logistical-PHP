...
<div class="container">
	<div class="row">
		<div class="containerbox">
			...
			<div class="order">
				...
				<div class="orderlist">
					<ul>
						...
						<li><a href="<?php echo U('index/thinginfo',array('id'=>$_SESSION['id'],'p'=>1));?>">同城速运订单</a></li>
					</ul>
				</div>
			</div>
			<div class="userinfo">
            ...
            <li><a href="<?php echo U('index/managecitysendaddr');?>">管理默认收货地址</a></li>
					</ul>
				</div>
			</div>
			</div>
	...
	<div class="rightbox col-md-9 col-sm-12">
			<div class="rightcontainer">
				...
				<?php if(is_array($thinginfo)): $i = 0; $__LIST__ = $thinginfo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$thing): $mod = ($i % 2 );++$i;?><table class="table-bordered table" style="table-layout: fixed;">
						...
						<tr>
							<td colspan="4" style="padding:10px 0;"><span style="padding-left: 60px;color: #7f7d7d">下单时间：</span><span style="font-weight: 800"><?php echo (date('Y-m-d ',$thing['create_time'])); ?></span><span style="padding-left: 15px;color: #7f7d7d;">订单更改时间：</span><span style="font-weight: 800"><?php echo (date('Y-m-d ',$thing['update_time'])); ?></span></td>
						</tr>
                ...
                <?php if(($thing['order_status'] == '未付款')): ?><a href="<?php echo U('index/orderdetail',array('id'=>$thing['id'],'flag'=>1));?>" target="_blank">查看订单</a>
                  <a href="<?php echo U('index/managecitysend',array('id'=>$thing['id']));?>">修改订单</a>
                  <br>
                  <!-- <a href="<?php echo U('index/selectpaymethod',array('id'=>$thing['id'],'flag'=>2));?>">立即付款</a> -->
                   <a class="payNow" id="payNow" href="javaScript:;">立即支付</a>
                <?php else: ?> 
                <a href="<?php echo U('index/orderdetail',array('id'=>$thing['id'],'flag'=>1));?>" target="_blank">查看订单</a>
                <a href="<?php echo U('index/managecitysend',array('id'=>$thing['id']));?>">修改订单</a><?php endif; ?>
							</td>
						</tr>
