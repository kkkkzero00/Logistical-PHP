...
<div class="logo">
	...
	<div class="display-none title-480">昊迅快递<br><p>后台处理平台</p></div>
</div>
<!-- END LOGO -->
...
<div class="content">
	...
	<form class="forget-form">
		...
		<div class="form-group">
			...
			<div class="input-icon">
				<i class="fa fa-user"></i>
				<input class="form-control" type="text" autocomplete="off" placeholder="" name="forget_username"/>
			</div>
		</div>
		<div class="form-group">
